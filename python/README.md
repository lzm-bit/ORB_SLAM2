...
At the moment, CMakeLists is hard-coded to use python 3.11. If you wish to use a different version, simply change the boost component used (python-311) to the desired version (say, python-39), on lines 6-7 of CMakeLists.txt.
